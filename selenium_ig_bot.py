...
start_bot("cryptobit.club","Giannelli97", [ "forex","crypto","bitcoin"])
                                              
1#money50.52M
2#fastmoney964.5K
3#youngmoney857.5K
4#moneymotivated840.7K
5#makingmoney831.8K
6#needmoney822.6K
7#freemoney816.4K
8#savingmoney797.4K
9#paytrenemoney731.6K
'''
browser = webdriver.Firefox()
browser.implicitly_wait(5)
...
#login_link = browser.find_element_by_class_name("f0n8F")
#login_link.click()
...
username_input.send_keys("crypto.genius.101")
sleep(2)
password_input.send_keys("Giannelli97")
sleep(2)
#<button class="sqdOP yWX7d    y3zKF     " type="button">Non ora</button>
login_button = browser.find_element_by_xpath("//button[@type='submit']")
login_button.click()
sleep(2)
memorize_cred = browser.find_element_by_xpath("/html/body/div[1]/section/main/div/div/div/div/button")
...
comment.click()
comment = browser.find_element_by_css_selector(".Ypffh")
comment.send_keys("Hello! Try our trading bot and start earning today")
comment.send_keys(Keys.ENTER)

post_comment = browser.find_element_by_xpath("/html/body/div[6]/div[2]/div/article/div[3]/section[3]/div/form/button[2]")
post_comment.click()
...
try:
    browser.find_element_by_xpath("//button[@type='consenti tutti i cokie']")

login_button = browser.find_element_by_xpath("//button[@type='consenti tutti i cokie']")
login_button.click()
sleep(1000)
